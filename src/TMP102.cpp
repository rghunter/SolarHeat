...
void TMP102::setConversionRate(byte rate)
{
  ...
  openPointerRegister(CFG_REGISTER);
  ...
  Wire.write(CFG_REGISTER); 	// Point to configuration register
...
void TMP102::setLowTempC(float temperature)
{
  ...
  openPointerRegister(CFG_REGISTER);	// Read configuration register settings
